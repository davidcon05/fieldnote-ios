...
2. ✅ All core features shipped

### v1.1 - Search & Intelligence (1-2 weeks)
3. Global search across all journals
4. Photo metadata extraction
5. Auto-populate log from photo GPS/DateTime

### v1.2 - Tagging & Filters (1-2 weeks)
6. Species tagging system
7. Advanced filtering (date range, weather, tags)
8. Dark mode optimization

### v1.5 - Navigation & Sharing (2-3 weeks)
9. Land navigation (GPS-guided return)
10. Single-entry sharing (export)
11. Weather refresh during edits

### v2.0 - Cloud Sync & AI (5-7 weeks)
12. Cloud backup & multi-device sync
13. Anonymous auth + Apple Sign In
14. Offline-first sync engine
15. AI species identification (iNaturalist API)

### v2.1 - Collaboration (2-3 weeks)
16. Multi-user journals
17. Invite-based sharing
18. Real-time collaboration

### v2.5+ - Advanced Tools
19. CSV/PDF export
20. Offline map tiles
21. LiDAR measurements

### v3.0+ - Advanced AI
22. Photo AI categorization & analysis
23. Audio species identification (bird calls)
24. Habitat detection from photos

---

## 🎯 Priority Matrix

| Feature | Priority | Effort | Impact | Milestone |
|---------|----------|--------|--------|-----------|
| Speech-to-text | ⭐⭐⭐ High | 2 weeks | High | ✅ v1.0 |
| Global search | ⭐⭐⭐ High | 2-3 days | High | v1.1 |
| Photo metadata | ⭐⭐⭐ High | 3-4 days | High | v1.1 |
| Land navigation | ⭐⭐⭐ High | 9 days | High | v1.5 |
| Single-entry sharing | ⭐⭐⭐ High | 3-5 days | High | v1.5 |
| Cloud sync | ⭐⭐⭐ High | 3-4 weeks | High | v2.0 |
| Species tagging | ⭐⭐ Medium | 5-7 days | Medium | v1.2 |
| AI species ID | ⭐⭐ Medium | 2-3 weeks | High | v2.0+ |
| Advanced filters | ⭐⭐ Medium | 1 week | Medium | v1.2 |
| Multi-user journals | ⭐⭐ Medium | 2-3 weeks | Medium | v2.1 |
| CSV/PDF export | ⭐⭐ Medium | 1 week | Medium | v1.6 |
| Dark mode optimization | ⭐ Low | 2-3 days | Low | v1.2 |
| Haptic feedback | ⭐ Low | 1 day | Low | v1.3 |
| Weather refresh | ⭐ Low | 2-3 days | Low | v1.5 |
| Photo AI categorization | ⭐ Low | 3-4 weeks | Medium | v3.0+ |
| LiDAR measurements | ⭐ Low | 2-3 weeks | Low | v3.0 |
...
3. Prioritize v1.1 features based on actual usage patterns
